...
An example of a more complex hierarchy would be a file viewer. You could imagine the model hierarchy for a file viewer to resemble the following.
...
And then this gives us a place to put all of our file-system business logic without mucking up our components.
