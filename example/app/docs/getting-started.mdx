...
It's an annoying bit of boilerplate, but once we've set up our models in this way, we can augment them with all sorts of getters and setters to do complex logic an our behalf. Also take note of the fields that we make observable and computed. This is a necessary step to make our fields reactive.
